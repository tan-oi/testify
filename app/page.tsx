      ...
      <section className="relative mx-auto my-6 md:my-10 flex max-w-7xl flex-col items-center justify-center">
        ...
        <div className="px-4 py-8 md:py-10 lg:py-20 w-full">
            ...
            {"Get testimonials in seconds, not hours"
              ...
              .map((word, index) => (
                <span
                  key={index}
                  className={`${
                    index === 0 ? "text-primary mr-2 sm:mr-3" : "mr-1 sm:mr-2"
                  } inline-block`}
                >
                  {word}
                </span>
          ...
          <p className="relative z-10 mx-auto max-w-xl py-4 px-2 text-center text-base sm:text-lg font-normal text-muted-foreground">
            Collect testimonials in just a few clicks. No more manual data
            entry. Just share your unique link and let your customers share
            their testimonials.
          </p>
          <div className="relative z-10 mt-6 md:mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link href={`${session?.user ? "/dashboard" : "/auth"}`}>
              <Button
                size="lg"
                className="text-base sm:text-lg px-6 sm:px-8 py-2.5 sm:py-3 rounded-xl w-full sm:w-auto min-w-[200px]"
              >
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="bg-blue-600 text-white text-xs sm:text-sm font-semibold px-2.5 sm:px-3 py-1 rounded-full mb-3 sm:mb-4">
                Step 1
              </div>
              ...
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                Create your unique testimonial collection link and share it with
                your customers via email, social media, or embed it on your
                website.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="bg-green-600 text-white text-xs sm:text-sm font-semibold px-2.5 sm:px-3 py-1 rounded-full mb-3 sm:mb-4">
                Step 2
              </div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-primary">
                Customers Submit
              ...
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                Your customers click the link and submit their testimonials
                through our simple, user-friendly form in just a few seconds.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="bg-purple-600 text-white text-xs sm:text-sm font-semibold px-2.5 sm:px-3 py-1 rounded-full mb-3 sm:mb-4">
                Step 3
              </div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-primary">
                Collect & Use
              ...
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                Automatically collect all testimonials in your dashboard.
                Export, embed, or showcase them anywhere to boost your
                credibility.
              </p>
            </div>
          </div>
      ...
      <section className="pt-2 pb-8 px-4 mb-8 md:mb-10">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-base sm:text-lg text-muted-foreground mb-6 md:mb-8 max-w-2xl mx-auto px-2">
            Join thousands of businesses who trust our platform to showcase
            their success stories and build credibility.
          </p>
          ...
          <p className="text-muted-foreground text-xs sm:text-sm mt-3 md:mt-4">
            Setup in 2 minutes
          </p>
        </div>
      </section>
      ...
      <footer className="bg-muted/50 border-t">
        <div className="max-w-7xl mx-auto px-4 py-8 md:py-12 text-center">
          ...
          <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto px-2">
            The fastest way to collect and showcase customer testimonials. Build
            trust and credibility with authentic reviews from your satisfied
            customers.
          </p>
        </div>
      </footer>
